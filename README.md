...
- 🎯 Entry points to execute your program using `python -m <pytorch_rocm_gtt>` or `$ pytorch_rocm_gtt` with basic CLI argument parsing.
...
Awesome pytorch_rocm_gtt created by pappacena
...
```py
from pytorch_rocm_gtt import BaseClass
from pytorch_rocm_gtt import base_function
